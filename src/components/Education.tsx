  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="border-l-2 border-resume-accent pl-6 py-2 hover:pl-8 transition-all duration-300">
              ...
              <p className="text-resume-secondary mt-1">
                University of The Philippines - Eastern Visayas
              </p>
              <p className="text-resume-secondary/70 mt-1">
            ...
            <ul className="space-y-3">
              {certifications.map((cert, index) => (
                ...
                >
                  ...
                  <span className="text-resume-secondary">{cert}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        >
          <h3 className="text-xl font-semibold text-resume-primary mb-6 text-center">
            Interests
          </h3>
